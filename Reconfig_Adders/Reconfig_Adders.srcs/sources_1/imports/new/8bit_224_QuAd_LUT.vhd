----------------------------------------------------------------------------------
-- 8 Bit QuAd Adder with sub-adder length 2,2 and 4
----------------------------------------------------------------------------------
...
architecture rtl of RCA_Adder is
  ...
  constant R : my_array_t := (2,2,4);             --number of resultant bits per sub adder
  constant P : my_array_t := (0,0,0);             --number of previous bits per sub adder
