...
set rc [catch {
  ...
  write_bitstream -force -cell ReConfig ReConfig_Four_Bit_RCA_LUT_partial.bit 
  catch {write_debug_probes -no_partial_ltxfile -quiet -force debug_nets}
  catch {file copy -force debug_nets.ltx top.ltx}
  catch {write_debug_probes -quiet -force -cell ReConfig -file ReConfig_Four_Bit_RCA_LUT_partial.ltx}
