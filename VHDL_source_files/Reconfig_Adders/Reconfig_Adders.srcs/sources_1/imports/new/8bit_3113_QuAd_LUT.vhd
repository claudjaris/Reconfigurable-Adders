----------------------------------------------------------------------------------
-- 8 Bit QuAd Adder with sub-adder length 3,1,1 and 3
----------------------------------------------------------------------------------
...
architecture rtl of RCA_Adder is
  ...
  constant N : positive := 8;                     --operand bit width
  constant R : my_array_t := (3,1,1,3);           --number of resultant bits per sub adder
